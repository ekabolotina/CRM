<?php
	...
	if($car_make && $car_model && $car_year && $car_number && ($query = $link->query("INSERT INTO `cars`(`car_make`, `car_model`, `year`, `car_number`, `user`, `car_body`, `car_color`) VALUES($car_make, $car_model, $car_year, '$car_number', $user, '$car_body', '$car_color')")))
		$status['error'] = 200;
	else
		$status['error'] = 201;
